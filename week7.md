...
为了获得上图所示的判定边界，我们的模型可能是![](media/92bdfda02d91ed3e4ae7ac2bee4377bb.png)
...
其中：![](media/550ad2c339eade766bda65880b874d38.png)，为实例$x$中所有特征与地标$l^{(1)}$之间的距离的和。上例中的similarity（x,$l^{(1)}$）就是核函数，具体而言，这里是一个**高斯核函数**（Gaussian Kernel）。 **注：这个函数与正态分布没什么实际上的关系，只是看上去像而已。**
