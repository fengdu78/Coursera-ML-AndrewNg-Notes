...
![](media/e5d3e8bfd41a9e0a2be62ca242513e50.png)
...
![](media/ad03b539f93a8440345d9ddf3af3b3ed.png)

![](media/36ddaa10b14ac1a4835547ed26b8bf7b.png)
...
![](media/1c69e8475fb75d271156c4a69af9d963.png)

一旦我们获得了平均值和方差的估计值，给定新的一个训练实例，根据模型计算 p(x)：

![](media/92dd64f6100a8ce490e0a3e67b4a506d.jpg)
...
![](media/40c79900e56c4960750428453bc3fbca.png)

![](media/36ddaa10b14ac1a4835547ed26b8bf7b.png)

注:其中μ是一个向量，其每一个单元都是原特征矩阵中一行数据的均值。最后我们计算多元高斯分布的p(x):

![](media/a4de9afd38a3c3d57de546bd5b5669b3.png)
...
![](media/1aa882140763ed77f2bd75e75637cc7e.png)

是一个n维向量，我想我的样本来自一个多元高斯分布。我如何尝试估计我的参数μ和Σ以及标准公式？

估计他们是你设置μ是你的训练样本的平均值。

![](media/c2a8dbcb9b3b8f77f1668daf6e709714.png)
...
![](media/81dbcb183b58fc92d0c2f12011b1a1e6.png)
...
![](media/97ce0b4bd2c8d83d746366ea6019833d.png)

如果我们要用梯度下降法来求解最优解，我们计算代价函数的偏导数后得到梯度下降的更新公式为：

![](media/bee72255d9d6fd5cec687dc35505d2dc.png)
...
![](media/9db087ad033c7cf41ace8863fa81135e.png)

但是如果我们既没有用户的参数，也没有电影的特征，这两种方法都不可行了。协同过滤算法可以同时学习这两者。

我们的优化目标便改为同时针对x和θ进行。

![](media/39942875158360bfae4445f04e0ac0df.png)

对代价函数求偏导数的结果如下：

![](media/fed8cf2974c6c037050f3f50f9f33ffe.png)
...
![](media/9bccc06030f71e1250060dfa440ccd01.png)

，估计

![](media/34c5300125060a8bb3760a3bdb53f34c.png)

：

![](media/cc6b1c3d5674576b3088c62c4cfe946b.png)

给定

![](media/311cf2caf2bd235676f626c0e9c4e79c.png)

，估计

![](media/cf3b5bd59fad3471519ecb9cfa684fcb.png)

：

同时最小化

![](media/11df9c0e2035018bf19163a4d4689fb2.png)

和

![](media/7880005d0d3dc11791162f2dc6b90e82.png)

：

![](media/ca8dbf5ccb61cee5313c1d1e2e88bec1.png)

![](media/0a114336798efe7a88090a4bcec0c46b.png)

![](media/bf50429769ba4c38b31630cc6b827d3b.png)
